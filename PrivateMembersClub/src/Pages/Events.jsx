  ...
  return (
    <>
      ...
      <FadeInSection>
        ...
        >
          Host with distinction at Alexander House. Whether you're planning an
          intimate celebration, a corporate gathering, or a creative showcase,
          our elegant spaces are available for private hire. With bespoke
          service, beautiful surroundings, and a discreet atmosphere, each house
          offers the perfect backdrop for memorable moments tailored to your
          vision.
        </p>
      </FadeInSection>
          ...
          <div className="row">
            <div className="col">
              ...
              <p style={{ fontSize: "23px" }}>
                ...
                ideal for intimate dinners, celebrations, or discreet
                gatherings. Each space is designed with comfort, style, and
                privacy in mind, complete with tailored service to elevate your
                experience.
              </p>
            </div>
            <div className="col">
      ...
      <FadeInSection>
        ...
        >
          Reserve Your Space Booking your event at Alexander House is seamless
          and personal. Whether you're hiring a private room, meeting space, or
