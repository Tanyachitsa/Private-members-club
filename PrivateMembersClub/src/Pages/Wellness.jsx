    ...
    <>
      ...
      <FadeInSection>
        ...
        >
          ...
          curated fitness classes designed for all levels. Step into our
          tranquil spa and wellness space to restore balance — with treatments,
          saunas, and relaxation areas crafted to rejuvenate body and mind.
          Whether you’re seeking energy or stillness, this is your sanctuary for
          everyday renewal.
        </p>
      </FadeInSection>
      <FadeInSection>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <p style={{ fontSize: "18px", marginBottom: "40px" }}>
                Our private gym features premium equipment, personal training,
                and space to move at your own pace. Designed for energy,
                strength, and everyday performance.
              </p>
              <h3>Opening Hours</h3>
              <p>
          ...
          <div class="row">
            <div class="col">
              ...
              <p style={{ fontSize: "18px" }}>
                Step into calm with tailored treatments, saunas, and serene
                spaces for rest and renewal. Wellness at Alexander House is
                where we practice self-care and stillness.
              </p>
              <h3>Opening Hours</h3>
              <p>
          ...
          <div class="row">
            <div class="col">
              ...
              <p style={{ fontSize: "20px" }}>
                Members can invite guests to experience Alexander House’s
                wellness and fitness spaces. Guest passes offer limited access
                to select facilities and events.
              </p>
            </div>
            <div class="col">
              <img
