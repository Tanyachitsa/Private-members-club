        ...
        <div className="row">
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Palm Pavilion </h4>
              <h5>- St Lucia -</h5>
              <p>
                A tranquil escape surrounded by lush greenery and natural wood
                finishes.
              </p>
            </FadeInSection>
          </div>
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Medina Room </h4>
              <h5>- Jordan -</h5>
              <p>
                Tiled elegance and intimate courtyards create a hidden haven.
              </p>
            </FadeInSection>
          </div>
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Guilded Room </h4>
              <h5>- London -</h5>
              <p>
                Golden accents and plush finishes evoke timeless elegance and
                classic comfort.
              </p>
            </FadeInSection>
          </div>
        ...
        <div className="row">
          ...
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Artsian Studio </h4>
              <h5>- Paris -</h5>
              <p>
                Textured walls, earthy palettes, and vintage furniture offer
                handcrafted comfort.
              </p>
            </FadeInSection>
          </div>
        ...
        <div className="row">
          ...
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Baobab Suite </h4>
              <h5>- Zimbabwe -</h5>
              <p>
                Rooted in strength and beauty, with grounding, natural decor.
              </p>
            </FadeInSection>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col">
            <FadeInSection>
              ...
              />
              <br />
              <h4>The Tuscan Retreat </h4>
              <h5>- Italy -</h5>
              <p>Warm stone walls, rustic charm, and golden light..</p>
            </FadeInSection>
          </div>
        </div>
      </div>
